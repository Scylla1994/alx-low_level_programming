...
/**
 * find_string_length - This function returns the length of a string.
...
/**
 * check_palindrome - A function that checks whether a string is a palindrome.
...
/**
 * is_palindrome - This is function that checks if a string is a palindrome.
